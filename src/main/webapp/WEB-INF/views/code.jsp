...
<body>
	<div class="container">
		...
		<div class="col-sm-4">
			...
			<button type="button" id="btn_store" class="btn btn-success"
				disabled="disabled" onclick="insert()">저장</button>
	...
	<div class="container">
		<form id="gbForm" class="form-inline"
			action="${pageContext.request.contextPath}/code/insertGb"
			method="post">
        ...
        -->
					<tr>
						<td><input class="form-control" id="lGroupCd"
							style="height: 25px" name="lGroupCd"></td>
						<td><input class="form-control" id="lGroupNm"
							style="height: 25px" name="lGroupNm"></td>
						<td><input class="form-control" id="lOrderBy"
							style="height: 25px" name="lOrderBy"></td>
					</tr>
				</tbody>
				<tfoot id="lGroup">
		...
		<div class="form-group col-sm-4">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td><input class="form-control" id="mGroupCd"
							style="height: 25px" name="mGroupCd"></td>
						<td><input class="form-control" id="mGroupNm"
							style="height: 25px" name="mGroupNm"></td>
						<td><input class="form-control" id="mOrderBy"
							style="height: 25px" name="mOrderBy"></td>
					</tr>
				</tbody>
				<tfoot id="mGroup">
